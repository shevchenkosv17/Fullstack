  ...
  apply(compiler) {
    ...
    const done = (stats, callback) => {
      ...
      if (this.opts.analyzerMode === "server") {
        actions.push(() => this.startAnalyzerServer(stats.toJson(analyzerStatsOptions)));
      } else if (this.opts.analyzerMode === "static") {
        actions.push(() => this.generateStaticReport(stats.toJson(analyzerStatsOptions)));
      } else if (this.opts.analyzerMode === "json") {
        actions.push(() => this.generateJSONReport(stats.toJson(analyzerStatsOptions)));
      }
      if (actions.length) {
